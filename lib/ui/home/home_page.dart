        ...
        actions: [
          IconButton(
            onPressed: () async{
              ...
              print("abc ${res['isSwitched']}");
              if(res != null && res['isSwitched'] == true){
          ...
          IconButton(
            onPressed: () async {
              ...
              _homeCubit.getData(res['location'],res['current'],res['condition'],res['listForecastday']);
            },
